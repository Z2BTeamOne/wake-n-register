...
describe('Finance Network', function () {
    ...
    describe('#createOrder', () => {
        ...
        it('should be able to create an order', () => {
            ...
            student.companyName = 'there is no student company';
            ...
            // the student of the commodity should be student (HUH?
            // said student, but now student still makes no sense)
            ...
            return businessNetworkConnection.getAssetRegistry(NS + '.Order')
                ...
                .then((newOrder) => {
                    ...
                    return businessNetworkConnection.submitTransaction(buyNow)
                        ...
                        .then((newOrder) => {
                            // the owner of the commodity should be
                            // student
                            newOrder.student.$identifier.should.equal(studentID);
